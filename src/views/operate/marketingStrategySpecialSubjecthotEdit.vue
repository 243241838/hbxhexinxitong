                    ...
                    <el-form label-width="150px" class="credit-aplly-form">
                        ...
                        <el-row style="margin-bottom:22px;">
                            ...
                            <el-col :span="14" style="position:relative;">
                                ...
                                <uploadImg v-on:acqImgUrl="acqImgUrl" v-bind:paramName="'specialLogo2'" ref="img2" style="width:122px;position:absolute;left:140px;top:0px;"
                                    v-bind:tip="''"></uploadImg>
                            </el-col>
                        </el-row>
                        <el-row style="margin-bottom:22px;">
                            <el-col :span="3" align="center" style="margin-top:8px;">
                        ...
                        <el-row v-show="productsResponsesData.length!=0">
                            <el-table :data="productsResponsesData" style="width: 100%">
                                ...
                                <el-table-column prop="productLogo" label="爆款专题图片" align="center" width="160">
                                    <template scope="scope">
                                        <img :src="scope.row.productLogo" v-if="scope.$index<=num-1" />
                                        <uploadImg v-on:acqImgUrl="acqImgUrl" v-bind:paramName="'Logo'+scope.$index" ref="img2" style="width:122px;" v-bind:tip="''"
                                            v-else></uploadImg>
                                    </template>
                                </el-table-column>
    ...
    export default {
        ...
        methods: {
            getDetail() {
                ...
                config(obj).then(response => {
                    if (response.respCode === '000000') {
                        ...
                        if (this.EditForm.specialType == 20) {
                            this.EditForm.specialType = '爆款';
                        }
                        ...
                        if (response.data.productsResponses && response.data.productsResponses.length > 0) {
                            this.num = response.data.productsResponses.length;
                            for (var i = 0; i < response.data.productsResponses.length; i++) {
                                this.productsResponsesData = this.productsResponsesData.concat({
                                    ...
                                    productLogo: response.data.productsResponses[i].productLogo
            ...
            commit() {
                ...
                if (this.productsResponsesData.length > 0) {
                    for (var i = 0; i < this.productsResponsesData.length; i++) {
                        ...
                        this.EditForm.specialProductsMap[this.productsResponsesData[i].productId] = {
                            ...
                            productLogo: this.productsResponsesData[i].productLogo
                ...
                if (this.EditForm.specialLogo2 == null || this.EditForm.specialLogo2 == "") {
                    this.$message({
                        type: 'warning',
                        message: '专题配图不能为空'
                    });
                ...
                for (let i = 0; i < this.productsResponsesData.length; i++) {
                    if (this.productsResponsesData[i].productLogo == null || this.productsResponsesData[i].productLogo ==
                        "") {
                        this.$message({
                            type: 'warning',
                            message: '爆款专题图片不能为空'
                ...
                if (this.EditForm.specialType == '爆款') {
                    this.EditForm.specialType = 20
                }
            ...
            acqImgUrl(params) {
                if ('specialLogo2' == params[1]) {
                    ...
                    let index = params[1].substr(4);
                    this.productsResponsesData[index].productLogo = params[0]
                }
