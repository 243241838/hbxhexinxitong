<template>
    <div>
        <div class="www-page">
            ...
            <div>
                <el-table :data="data.claimRecordsPoList" v-loading="listLoading" fit border highlight-current-row style="width: 100%">
                    ...
                    <el-table-column label="操作" align="center" width="100">
                        <template scope="scope">
                            <span style="color:#3498da;cursor:pointer;">[跟进]</span>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="productId" label="用户ID" width="120" align="center"></el-table-column>
