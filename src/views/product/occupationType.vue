<template>
    <div class="app-container calendar-list-container">
        <div class="filter-container">
            <span>关键字:</span>
            <el-input v-model="listQuery.params.codeName" placeholder="关键字" style="width:200px;margin-right: 50px;"></el-input>
            <span>最高职业类别:</span>
            <el-select clearable style="width:200px" class="filter-item" v-model="listQuery.params.codesValue" placeholder="最高职业类别">
