        ...
        <el-tabs v-model="tabsName" type="card" @tab-click="handleClick">
            <el-tab-pane label="基本信息" name="first">
                <div class="filter-container">
                    ...
                    <div class="filter-container">
                        <el-form label-width="150px" :model="userInfoData.params" :rules="rules" ref="userInfo" class="credit-aplly-form">
                            ...
                            <el-form-item prop="productFeature" label="产品亮点1:" required>
                                <el-input v-model="userInfoData.params.productFeature" style="width:320;">
                                </el-input>
                            </el-form-item>
                            <el-form-item prop="perferWords" label="产品亮点2:" required>
                                <el-input v-model="userInfoData.params.perferWords" style="width:320;">
                                </el-input>
                            </el-form-item>
                            <el-form-item prop="productLogo" label="产品图片:" required>
                                <uploadImg v-on:acqImgUrl="acqImgUrl" v-bind:paramName="'userInfoData.params.productLogo'"></uploadImg>
                            </el-form-item>
                            ...
                            <el-form-item prop="classId" label="保险类别:" required>
                                ...
                                <el-select clearable style="width:160px" class="filter-item" v-model="userInfoData.params.classId" placeholder="保险子类">
                            ...
                            <el-form-item label="产品有效期:" required>
                                <el-date-picker prop="effTime" v-model="userInfoData.params.effTime" type="date" placeholder="起始时间" :editable="false" @change="dateChange">
                                </el-date-picker>至
                                <el-date-picker prop="expTime" v-model="userInfoData.params.expTime" type="date" placeholder="结束时间" :editable="false" @change="dateChange">
                                </el-date-picker>
                            </el-form-item>
                            ...
                            <el-form-item prop="vehicleCommisionValue1" label="交强险一级佣金:" required>
                                <el-input style="width:320px;" v-model.number="userInfoData.params.vehicleCommisionValue1"></el-input>%
                            </el-form-item>
                            <el-form-item prop="vehicleCommisionValue2" label="交强险二级佣金:" required>
                                <el-input style="width:320px;" v-model.number="userInfoData.params.vehicleCommisionValue2"></el-input>%
                            </el-form-item>
                ...
                <!-- <iframe :src="userInfoData.params.insuranceTerms" frameborder="0"></iframe> -->
            </el-tab-pane>
            <el-tab-pane label="保障信息" name="second">
                ...
                <el-dialog title="保障计划新增" :visible.sync="dialogFormVisible">
                    ...
                    <div v-for="(item,index) in carInsTtemList" :key="index" style="margin-bottom:10px;margin-top:10px;">
                        <el-row>
...
export default {
    ...
    data() {
        return {
            ...
            carProductTPriceList: { params: { url: 'product/carProductTPrice', productId: this.productId } },
            productPlansList: [],
    ...
    methods: {
        ...
        //编辑信息保存
        Commit() {
            console.log(this.userInfoData.params.productLogo);
            let isSuccess = true;
            ...
            if(this.userInfoData.params.classId){
        ...
        AddSave() {
            ...
            this.carInsTtemList.forEach((item, index) => {
                if (item.trueSts) {
                    let franchiseFlag = null;
                    if (!item.hasFranchise) {
                        franchiseFlag = -1;
        ...
        carInsTtemEdit(index) {
            ...
            //this.carInsItemListEdit = this.productPlansList[index];
        ...
        uploadFail(status, field, keys) {
            this.userInfoData.params.insuranceTerms = data.entity;
            this.$message.error('上传失败');
            this.showUpload = false;
        },
        confirm() {
